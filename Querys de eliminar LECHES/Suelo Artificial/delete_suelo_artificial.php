...
$id_suelo_artificial_recibido=$_REQUEST['id_suelo_artificial'];
        ...
        $sql="UPDATE suelo_artificial SET estatus='eliminado' WHERE id_suelo_artificial=".$id_suelo_artificial_recibido;
        $resultado= $conexion->query($sql) ;
        echo "suelo artificial eliminado";
