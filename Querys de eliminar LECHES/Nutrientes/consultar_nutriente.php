...
<link href="../css/sb-admin.css" rel="stylesheet">
    ...
    <table class="table table-striped ">
        <thead class="thead-dark">
                ...
                <?php $sql="SELECT id_cultivo,id_agroquimico, aplicacion,nombre_comercial, precio, moneda,cantidad,unidad,dosis,tiempo,tipo_causa, frecuencia, fecha_inicio,fecha_fin,existencia,fecha_registro,fecha_modif FROM agroquimicos where aplicacion='nutriente' and estatus='activo'";
      ...
      <!-- <td><//?php echo $fila['id_u'];?></td>  -->
                ...
                <a href="modificar_nutriente.php?id_agroquimico=<?php echo $fila["id_agroquimico"];?>" id="edi">Editar</a><a href="delete_nutriente.php?id_agroquimico=<?php echo $fila["id_agroquimico"];?>" id="eli">Eliminar </a></td>
