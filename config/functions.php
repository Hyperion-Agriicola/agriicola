                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datepicker" placeholder="Fecha" class="form-control" id="inputFechaInicio" class="inputFechaInicio" name="fecha_inicio" value="'.$row['fecha_inicio'].'">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datepicker" placeholder="Fecha" class="form-control" id="inputFechaFinal" class="inputFechaFinal" name="fecha_fin" value="'.$row['fecha_fin'].'">
                                    </div>
                                </div>
