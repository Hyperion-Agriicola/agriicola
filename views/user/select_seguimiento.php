...
<header class="bg-light p-4 pt-5 mt-4" >
        ...
        <div class="row mb-5 py-5 border-bottom border-success" style="border-bottom: 2px solid #388E3C!important;">
            ...
            <div class="col-md-4 col-sm-10">
                <a href="dashboard.php?Tracing=<?php echo $_GET['Tracing'];?>&Ground=<?php echo $_GET['Ground'];?>" class="href text-decoration-none">
                    <button type="button" class="btn0 btn btn-light btn-block p-3 shadow mb-4 text-white" style="font-size: 20px; text-align:center; background-color: #388E3C;">
    ...
    document.getElementById("endCrop").addEventListener("click", function(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                document.location = "dashboard.php?end=<?php echo $_GET['Tracing']; ?>";
            }
        })
