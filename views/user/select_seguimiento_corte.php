...
<div class="container">
        ...
        <div class="row mb-5 pb-5">
            ...
            <div class="col-md-4 col-sm-10">
                <a href="dashboard.php?res=<?php echo $_GET['cut'];?>&Ground=<?php echo $_GET['Ground'];?>" class="href text-decoration-none">
                    <button type="button" class="btn3 btn-light btn-block p-3 shadow mb-4" style="font-size: 20px; text-align:center;">
...
<script>
    document.getElementById("endCrop").addEventListener("click", function(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                document.location = "dashboard.php?end=<?php echo $_GET['cut']; ?>";
            }
        })
