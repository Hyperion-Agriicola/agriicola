...
<div class="container">
    ...
    <div style="display: none;">
        <form id="crop-form" name="crop" class="crop" action="#" method="POST" >
            ...
            <div class="swal2">
                <button name="modifCrop" type="submit" class="swal2-confirm swal2-styled" style="background-color: #388e3c;">Aceptar</button>
            </div>
        </form>
    </div>
    ...
    <div style="display: none;">
        <form id="artground-form" action="" method="post">
            ...
            <div class="swal2">
                ...
                <button name="modifGroundArt" type="submit" class="swal2-confirm swal2-styled" style="background-color: #388e3c;">Aceptar</button>
            </div>
        </form>
    </div>
    ...
    <div style="display: none;">
        <form id="natground-form" class="groundre" action="" method="POST">
            ...
            <div class="swal2">
                ...
                <button name="modifGroundNat" type="submit" class="swal2-confirm swal2-styled" style="background-color: #388e3c;">Aceptar</button>
            </div>
        </form>
    </div>
    ...
    <div style="display: none;">
        <form id="addAgro-form"class="reg_agro" action="" method="post">
            ...
            <div class="swal2">
                ...
                <button id="addAgro" name="addAgro" type="submit" class="swal2-confirm swal2-styled" style="background-color: #388e3c;">Aceptar</button>
            </div>
        </form>
    </div>
